...
\urlstyle{same}
\hypersetup{
  pdftitle={Putting Fortran\textquotesingle s object-related features to practical use},
...
\pandocbounded{\includegraphics[keepaspectratio]{Inheritance_diagram.svg.png}}\{height=8cm\}
...
\item
  ...
  \href{User:RBaSc/draft_ftnoo\#Type-bound_procedures_(TBP)}{type-bound
...
\item
  ...
  hierarchy adheres to the \href{Liskov_substitution_principle}{Liskov
...
\item
  ...
  \texttt{SUBMODULE\ (}\texttt{:}\texttt{)\ }\textless submodule\_name\textgreater{}
...
\pandocbounded{\includegraphics[keepaspectratio]{Dependency_inversion.svg.png}}\{height=8cm\}
